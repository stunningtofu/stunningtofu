...
## Highlights
- Designed and shipped scalable APIs that handled millions of requests/month
- Improved CI/CD pipelines to reduce release time from days to hours
- Mentor for junior engineers and active contributor to several OSS projects
...
- Containerization & Orchestration: Docker, Podman, Kubernetes (k8s), EKS,  
- CI/CD & Automation: GitHub Actions, Jenkins, GitlabCI
...
## How I Work
1. Start with user & product outcomes, then map technical solutions.
2. Iterate quickly—ship small, test often, and monitor in production.
3. Prioritize readable code, thorough tests, and clear documentation.
